      ...
      <div class="content-area-wrapper">
        <div class="sidebar-left">
		  ...
		  <div class="chat-sidebar-search position-relative">
			...
			<ul class="chat-sidebar-list">
			  <li ng-repeat="parent in parents" role="button" >
				<div class="d-flex align-items-center" ng-click="selectParent(parent)">
				  <div class="avatar m-0 mr-50"><img src=<?=base_url()?>{{parent.picture}} height="36"
					  width="36" alt="img">
				  </div>
				  <div class="chat-sidebar-name">
					<h6 class="mb-0">{{parent.parent_name}}</h6><span class="text-muted"></span>
				  </div>
				</div>
			  </li>
			  </ul>
        ...
        <div class="content-right">
          ...
          <div class="content-wrapper">
            ...
            <div class="content-body" ng-init="selectParentName=''"><!-- app chat overlay -->
			<div class="chat-overlay"></div>		
			<section class="chat-window-wrapper">
			  <div class="chat-start" ng-class="{'d-none':selectParentName.length>1}">
			  ...
			  <header class="d-flex justify-content-between align-items-center border-bottom px-1 py-75">
				<div class="d-flex align-items-center">
				  ...
				  <div class="avatar chat-profile-toggle m-0 mr-1">
					<img src="<?=base_url()?>{{selectParentPicture}}" alt="avatar" height="36" width="36" />
				  </div>
				  <h6 class="mb-0">{{selectParentName}}</h6>
				</div>
			  ...
			  <div class="card-content">
				<div class="card-body chat-container">
				  <div class="chat-content">
					<div ng-repeat="message in messages" class="chat" ng-class="{'chat-left': message.sent=='<?=SENDERPARENT?>'}">
...
<!-- Dashboard Ecommerce ends -->
   ...
   <div class="sidenav-overlay"></div>
	...
	var url="<?=base_url()?>api/parentdata/all";
	$http.get(url).then(function (response) {
	$scope.parents=response.data[0];
	...
	{	
		$scope.selectParentName=parent.parent_name;
		$scope.selectParentPicture=parent.picture;
		$scope.selectParentId=parent.id;
		$scope.hiddenParent=parent;
		console.log("selectParentName");
		console.log($scope.selectParentName.length);
		var url="<?=base_url()?>api/communicate/parent";
		var data={
		parentId:$scope.selectParentId
		};
	...
	$scope.sendMessage = function(){
		var url="<?=base_url()?>api/sendmessage/admin";
		var data={
