...
<section id="dashboard-ecommerce" ng-controller="dashboard_controller">
 ...
 <div class="card" >
        ...
        <div class="card-content">
          <div class="card-body">
            <?=form_open_multipart("staff/addingclass","class='form ' id='addingclass'")?>
              <div class="form-body">
                <div class="row justify-content-center">
                  ...
                  <div class="col-4">
					...
					<input type="text" class="form-control" id="topic" name="class_name" placeholder="Class Name"></input>
