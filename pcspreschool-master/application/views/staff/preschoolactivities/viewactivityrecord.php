                ...
                <div class="row">
				  ...
				  <h3 class="pb-1">Basic Info</h3>
                    ...
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="full-name-floating-icon" ><?=ucwords($activity["name"])?></h4>
                    </div>
                  </div>
                    ...
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="gender" ><?=ucfirst($activity["description"])?></h4>
                    ...
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="childDob" ><?=(new DateTime($activity["activity_date"]))->format("d/M/Y")?></h4>
                    </div>
                  </div>
				  ...
				  <div class="col-12">
                    <div class="form-label-group position-relative has-icon-left">
                      ...
                      <p for="chilob">Remarks</p>
					  <h4 class="form-control-static" id="chilob" ><?=$activity["remarks"]?></h4>
                    </div>
                  </div>
				<!--Column-->
