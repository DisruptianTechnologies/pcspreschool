...
<head>
	...
	<style>
	.pdfobject-container { height: 30rem;width:100%; border: 1rem solid rgba(0,0,0,.1); }
	</style>
    <!-- END: Page CSS-->
                ...
                <div class="row">
				  ...
				  <h3 class="pb-1">Basic Info</h3>
                    ...
                    <div class="form-label-group position-relative has-icon-left">
                      <p for="full-name-floating-icon">Topic</p>
					  <h4 class="form-control-static" id="full-name-floating-icon" ><?=ucwords($announcement["topic"])?></h4>
                    </div>
                  </div>
				  
					<div class="col-12">
                    <div class="form-label-group position-relative has-icon-left">
					  <p for="gender">Description</p>
					  <h4 class="form-control-static" id="gender" ><?=ucwords($announcement["description"])?></h4>
                    ...
                    <div class="form-label-group position-relative has-icon-left">
                      ...
                      <p for="childDOB">Date</p>
					  <h4 class="form-control-static" id="childDob" ><?=(new DateTime($announcement["date"]))->format("d/M/Y")?></h4>
                    </div>
                  </div>
				<!--Column-->
                  ...
                  <div class="col-6">
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="time" ><?=$announcement["time"]?></h4>
					</div>
                  </div>
				<!--Column Start-->
                  <div class="col-12 justify-content-center">
				  <?php if(pathinfo($announcement['attachment'])['extension']=="pdf"):?>
				<a href="<?=base_url($announcement['attachment'])?>">Download PDF</a>

				  <object data="<?=base_url($announcement['attachment'])?>" type="application/pdf" width="100%" height="550px">
			   	<iframe src="<?=base_url($announcement['attachment'])?>" width="100%" height="550px" style="border: none;">
				This browser does not support PDFs. Please download the PDF to view it: 
				<a href="<?=base_url($announcement['attachment'])?>">Download PDF</a>
				</iframe>
				</object>
				  <?php else:?>
				  <img src="<?=base_url($announcement['attachment'])?>" alt="Announcement Attachement">
				  <?php endif;?>
...
<!-- Dashboard Ecommerce ends -->
   ...
   <div class="sidenav-overlay"></div>
    ...
    <!-- BEGIN: Page Vendor JS-->
		<script src="<?=base_url("px-includes/app-assets/vendors/js/pdfobject/pdfobject.js")?>"></script>
    ...
    <!-- BEGIN: Page JS-->
	<script>
	PDFObject.embed("<?=base_url($announcement['attachment'])?>", "#pdfholder")
	</script>
