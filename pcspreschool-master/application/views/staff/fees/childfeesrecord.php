				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">Fee Payment Record</h4>
						</div>
							...
							<div class="card-body card-dashboard">
								...
								<div class="table-responsive">
									<table class="table zero-configuration">
										...
										<tbody>
										<?php foreach($fees as $key=>$st):?>
											<tr>
												<td><?=$st["transaction_id"]?></td>
												<td><?=$st["payment_date"]?></td>
												<td><?=ucwords($st["class_name"])?></td>
												<td><?=$st["roll_no"]?></td>
												<td><?=ucfirst($st["child_name"])?></td>
												<td><?=$st["payment_amount"]?></td>
											</tr>
										<?php endforeach;?>
