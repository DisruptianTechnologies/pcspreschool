...
<section id="dashboard-ecommerce" ng-controller="dashboard_controller">
 ...
 <div class="card" >
        ...
        <div class="card-content">
          <div class="card-body">
            <?=form_open_multipart("staff/addingnote","class='form ' id='addingmealplan'")?>
              <div class="form-body">
                <div class="row justify-content-center">
				  ...
				  <div class="form-label-group position-relative has-icon-left">
					...
					<select class="form-control" name="type" id="topic-floating-icon">
					...
					<div class="form-control-position">
                      ...
                      <label for="topic-floating-icon">Note Type</label>
				  </div>
				  </div>
				  </div> 
				  </div> 
				...
				<!--Column Start-->
                  ...
                  <div class="col-4">
                    <div class="form-label-group position-relative has-icon-left">
					<textarea class="form-control" id="description" name="remarks" for="addingannouncement" rows="3" placeholder="description"></textarea>
                      <div class="form-control-position">
                  ...
                  <div class="col-4">
					  ...
					  <input type="file" class="dropify" name="picture" data-max-file-size="4M" data-allowed-file-extensions="png jpg jpeg webp" id="dropsinglepdfimage"/>
				  </div>
				  </div>
				  </div>
