...
<section id="dashboard-ecommerce" ng-controller="dashboard_controller">
 ...
 <div class="card" >
        ...
        <div class="card-content">
          <div class="card-body">
            <?=form_open_multipart("staff/addingchild","class='form' id='addchild'")?>
              <div class="form-body">
                <div class="row">
				  <!--Column-->
				  ...
				  <div class="col-md-6 col-12">
					...
					<div class="col-12">
                    <div class="form-label-group position-relative has-icon-left">
					<input type="text" name="dob" class="form-control pickadate-months-year picker__input" placeholder="Select Date of Birth" readonly="" id="childDOB" aria-haspopup="true" aria-expanded="true" aria-readonly="false" aria-owns="P1197894580_root"/>    
					<div class="form-control-position">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-label-group position-relative has-icon-left">
						<input type="text" name="allergy_type" id="allergytype" placeholder="Allergy(If Any)" class="form-control"/>
					  <div class="form-control-position">
				...
				<!--Column Start-->
                  <div class="col-12 col-md-6">
                    <div class="form-label-group position-relative has-icon-left">
					<textarea class="form-control" id="address" name="address" for="addchild" rows="2" placeholder="Address"></textarea>
                      <div class="form-control-position">
                  ...
                  <div class="col-12 col-md-6">
					...
					<div class="col-md-6 col-12">
                    <div class="form-label-group position-relative has-icon-left">
                      <input type="text" id="rollno-floating-icon" class="form-control" name="roll_no" placeholder="Roll No">
                      <div class="form-control-position">
                        <i class="bx bx-user"></i>
                      </div>
				  ...
				  <div data-repeater-list="parent">
					<div data-repeater-item="">
					  <div class="row justify-content-between">
						<div class="col-md-3 col-sm-12 form-group">
						  <label for="pname">Name </label>
						  <input type="text" class="form-control" name="name" id="pname" placeholder="Enter name">
						</div>

						<div class="col-md-3 col-sm-12 form-group">
						  <label for="pmail">Email </label>
						  <input type="email" class="form-control" name="email" id="pmail" placeholder="Enter email id">
						</div>
						<div class="col-md-3 col-sm-12 form-group">
						  <label for="pphone">Phone number</label>
						  <input type="parent_phno" class="form-control" id="pphone" name="phno" placeholder="Enter Phone Number">
						</div>
						<div class="col-md-3 col-sm-12 form-group">
						  <label for="ptype">Parent Type</label>
						  <select name="parent_type" id="ptype" class="form-control">
