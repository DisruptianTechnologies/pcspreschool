                ...
                <div class="row">
				  ...
				  <h3 class="pb-1">Basic Info</h3>
                    ...
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="full-name-floating-icon" ><?=ucwords($staffData["staff_name"])?></h4>
                    </div>
                  </div>
                    ...
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="gender" ><?=ucwords($staffData["gender"])?></h4>
                    ...
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="childDob" ><?=(new DateTime($staffData["dob"]))->format("d/M/Y")?></h4>
                    </div>
                  </div>
				  ...
				  <div class="col-md-6 col-12">
                    <div class="form-label-group position-relative has-icon-left">
                      ...
                      <p for="doj">Date of Joining</p>
					  <h4 class="form-control-static" id="doj" ><?=(new DateTime($staffData["start_date"]))->format("d/M/Y")?></h4>
                    </div>
                  </div>
                  </div>
				</div>
				...
				<!--Column Start-->
                  <div class="col-12 col-md-6">
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="address" ><?=ucwords($staffData["address"])?></h4>
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="form-label-group position-relative has-icon-left">
                      <p for="country-floating-icon">Country</p>
					  <h4 class="form-control-static" id="country-floating-icon" ><?=ucwords($staffData["country"])?></h4>
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-label-group position-relative has-icon-left">
					  ...
					  <h4 class="form-control-static" id="state-floating-icon" ><?=ucwords($staffData["state"])?></h4>
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="form-label-group position-relative has-icon-left">
                      <p for="contact-floating-icon">Zipcode</p>
					  <h4 class="form-control-static" id="class-floating-icon" ><?=ucwords($staffData["zipcode"])?></h4>
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="form-label-group position-relative has-icon-left">
                      <p for="class-floating-icon">Class</p>
					  <h4 class="form-control-static" id="class-floating-icon" ><?=$staffData["class_name"]?></h4>
                    </div>
                  </div>

                  <div class="col-12 col-md-6">
                    <div class="form-label-group position-relative has-icon-left">
                      <p for="floating-icon">Schedule Day</p>
					  <h4 class="form-control-static" id="class-floating-icon" ><?=implode(",",$staffData["schedule_day"])?></h4>
                    </div>
                  </div>
...
$("#child_avatar").fileinput({
    ...
    defaultPreviewContent: '<img src="<?=base_url($staffData["picture"])?>" style="height:185px;width:185px" alt="Your Avatar">',
