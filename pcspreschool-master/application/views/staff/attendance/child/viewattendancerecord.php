				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<img class="round" style="height:100px;width:100px" src="<?=base_url($child["picture"])?>"/>
							<h4 class="card-title">View Attendance of <?=$child["child_name"]?></h4>
						</div>
...
<!-- Dashboard Ecommerce ends -->
   ...
   <div class="sidenav-overlay"></div>
	...
	<script>
		var events = [
		  <?php foreach($childAttendance as $st):?>
		  <?php if($st['status']==PRESENT):?>
			{'Date': new Date("<?=$st['attendance_date']?>"),'Color':'#49EC4A' ,'Title': 'Present'},
