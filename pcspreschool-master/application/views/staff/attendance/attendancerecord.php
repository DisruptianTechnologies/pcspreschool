				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">Staff Attendance Record</h4>
						</div>
									...
									<table class="table zero-configuration">
										...
										<?php foreach($staff as $key=>$st):?>
											<tr>
												...
												<td><a href="<?=base_url("staff/attendance/").$st["staff_id"]?>"><i style="font-weight:600;font-size:36px" class="bx bx-check"></i></td>
											</tr>
										<?php endforeach;?>
