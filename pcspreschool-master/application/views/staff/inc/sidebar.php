 ...
 <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
          ...
          <li class=" nav-item"><a href="<?=base_url("staff/attendance")?>"><i class='bx bx-user-check'></i><span class="menu-title" data-i18n="Attendance">Staff Attendance</span></a>
          </li>
		  ...
		  <li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Classes">Fees</span></a>
            <ul class="menu-content" style="">
              ...
              <li class="is-shown"><a href="<?=base_url("staff/addfees")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Add Announcement">Add Class Fee</span></a>
              </li>
		  ...
		  <li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Staff">Communication</span></a>
            <ul class="menu-content" style="">
              <li class="is-shown"><a href="<?=base_url("staff/communicate/parent")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" >Parent</span></a>
              </li>
              <li class="is-shown"><a href="<?=base_url("staff/communicate/staff")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" >Staff</span></a>
              </li>
            </ul>
          </li>	

		  <li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Staff">Staff</span></a>
            <ul class="menu-content" style="">
              <li class="is-shown"><a href="<?=base_url("staff/addstaff")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Add Staff">Add Staff</span></a>
              </li>
              <li class="is-shown"><a href="<?=base_url("staff/viewstaff")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="View Staff">View staff</span></a>
              </li>
            </ul>
          </li>	
		...
		<li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Classes">Classes</span></a>
			...
			<?php foreach($classes as $class):?>
			  ...
			  <?php endforeach;?>
			  <hr/>
              <li class="is-shown"><a href="<?=base_url("staff/addclass")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Add Class">Add Class</span></a>
              </li>
            </ul>
          </li>

		  <li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Classes">Child</span></a>
            <ul class="menu-content" style="">
              <li class="is-shown"><a href="<?=base_url("staff/addchild")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Add Child">Add Child</span></a>
              </li>
              <li class="is-shown"><a href="<?=base_url("staff/deletedchildren")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Deleted Children">Deleted Children</span></a>
              </li>
            </ul>
          </li>
		  ...
		  <li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Classes">Announcement</span></a>
            <ul class="menu-content" style="">
              ...
              <li class="is-shown"><a href="<?=base_url("staff/addannouncement")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Add Announcement">Add Announcement</span></a>
              </li>
            </ul>
          </li>
		  <li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Calendar">Calendar</span></a>
            <ul class="menu-content" style="">
              ...
              <li class="is-shown"><a href="<?=base_url("staff/addpreschoolactivity")?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Add Child">Add Activity</span></a>
              </li>
            </ul>
          </li>
          <li class=" navigation-header"><span>Settings</span>
          </li>
			<li class=" nav-item"><a href="<?=base_url("staff/settings")?>"><i class='bx bx-home-alt'></i><span class="menu-title" data-i18n="Settings"><span class="text-bold-500">Settings</span></span></a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
		...
		<li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Classes">Classes</span></a>
            <ul class="menu-content" style="">
			<?php foreach($classes as $class):?>
				<?php if(in_array($class["id"],json_decode($this->session->userdata("class_id")))):?>
              <li class="is-shown"><a href="<?=base_url("staff/selectedclass/").$class['id']?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="<?=ucfirst($class['name'])?>"><?=ucfirst($class['name'])?></span></a>
              </li>
			  <?php endif;?>
			  <?php endforeach;?>
