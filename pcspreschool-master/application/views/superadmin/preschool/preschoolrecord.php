...
<section id="dashboard" ng-controller="dashboard_controller">
 ...
 <!--Cards Start--> 
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">Preschool Record</h4>
						</div>
      ...
      <a class="dropdown-item" href="<?=base_url('superadmin/editpreschool/').$cs["id"]?>"><i class="bx bx-user mr-50"></i>View Preschool</a>    
	<hr/>
	  <a class="dropdown-item" href="<?=base_url('superadmin/addadmin/').$cs["id"]?>"><i class="bx bx-user mr-50"></i>Add Admin</a>  
	  
	  <a class="dropdown-item" href="<?=base_url('superadmin/viewadmin/').$cs["id"]?>"><i class="bx bx-user mr-50"></i>View Admin</a>     
		
		<hr/>
	  <a class="dropdown-item" href="#" data-toggle="modal" data-target="#default_<?=$key+1?>"><i class="bx bx-check-square mr-50"></i>Delete/Inactive Preschool</a>
	  </div>
	   <div class="modal fade text-left" id="default_<?=$key+1?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
              aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable" role="document">
			  <?=form_open("superadmin/inactivepreschool")?>
                <div class="modal-content">
                  <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel1">Inactive Confirmation</h3>
                  ...
                  <div class="modal-body">
					...
					<input type="hidden" name="preschool_id" value="<?=$cs["id"]?>">
                      Are you sure you want to Inactive/Delete <?=ucwords($cs["name"])?>?
                    </p>
                  </div>
