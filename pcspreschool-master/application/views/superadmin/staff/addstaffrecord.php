...
<section id="dashboard-ecommerce" ng-controller="dashboard_controller">
 ...
 <div class="card" >
        ...
        <div class="card-content">
          <div class="card-body">
            <?=form_open_multipart("superadmin/addingstaff","class='form' id='addstaff'")?>
              <div class="form-body">
                <div class="row">
				  <!--Column-->
				  ...
				  <div class="col-md-6 col-12">
					...
					<div class="col-md-6 col-12">
                    <div class="form-label-group position-relative has-icon-left">
					<input type="date" name="dob" class="form-control pickadate-months-year picker__input" placeholder="Select Date of Birth" readonly="" id="staffDOB" aria-haspopup="true" aria-expanded="true" aria-readonly="false" aria-owns="P1197894580_root"/>    
					<div class="form-control-position">
