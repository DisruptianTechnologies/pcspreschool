...
<section id="dashboard" ng-controller="dashboard_controller">
 ...
 <!--Cards Start--> 
    ...
    <a class="dropdown-item" href="<?=base_url('superadmin/editadmin/').$st["staff_id"]?>"><i class="bx bx-check-square mr-50"></i>Edit Staff</a><a class="dropdown-item" href="#" data-toggle="modal" data-target="#default_<?=$key+1?>"><i class="bx bx-check-square mr-50"></i>Toggle Employment Status</a>
	              </div>

	              <div class="modal fade text-left" id="default_<?=$key+1?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
              aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable" role="document">
			  <?=form_open("superadmin/changestatusadmin")?>
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>
					<input type="hidden" name="admin_id" value="<?=$st["staff_id"]?>">
					<input type="hidden" name="emp_stat" value="<?=$st["employed"]?>">
                      Are you sure you want to Toogle Employment Status of<?=ucwords($st["staff_name"])?>?
                    </p>
                  </div>
