...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url("px-includes/app-assets/css/pages/authentication.css")?>">
    <!-- END: Page CSS-->
        ...
        <div class="card bg-authentication mb-0">
            <div class="row m-0">
                    ...
                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                        <div class="card-header pb-1">
                            <div class="card-title">
                                <h4 class="text-center mb-2">Welcome Super Admin</h4>
                            </div>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <img src="https://pcs.freeschoolerp.in/assets/images/logo-safety.png" style="height:100px;width:100px"> 
                                <div class="divider">
                                    <div class="divider-text text-uppercase text-muted"><small> login with
                                            email or phone number</small>
                                    </div>
                                </div>
								<div class="text-danger">
								<?=$this->session->flashdata("valid_error")?>
								<?=$this->session->flashdata("status")?>
								</div>
                                <form action="<?=base_url("superadmin/loginsuperadmin")?>" method="post">
                                    <div class="form-group mb-50">
                                        <label class="text-bold-600" for="exampleInputEmail1">Email address/Phone Number</label>
                                        <input type="text" name="loginUniq" class="form-control" id="exampleInputEmail1"
                                    ...
                                    <div
                                        ...
                                        <div class="text-right"><a href="<?=base_url("parent/forgot_password")?>"
                                ...
                                <hr>
								<a href="<?=base_url("staff")?>"><small>Login As Staff</small></a>
								<a href="<?=base_url("parent")?>"><small>Login As Parent</small></a>
                                <div class="text-center"><small class="mr-25">Don't have an account?</small>
								<a href="<?=base_url()?>"><small>Sign up</small></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                    <div class="card-content">
                        <img class="img-fluid" src="<?=base_url("px-includes/app-assets/images/pages/login.png")?>" alt="branding logo">
                    </div>
                </div>
            </div>
        </div>
